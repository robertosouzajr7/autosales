        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-slate-900 p-12 rounded-[50px] shadow-3xl relative overflow-hidden">
           ...
           <div className="space-y-3 relative z-10">
              <h1 className="text-4xl font-black text-white tracking-tighter uppercase flex items-center gap-4">
                 Jornadas de <span className="text-[#820AD1] italic">Deep Research</span>
              </h1>
           ...
           <Button onClick={() => handleOpenModal()} className="h-16 px-10 rounded-2xl font-black uppercase text-xs tracking-widest shadow-2xl transition-all hover:-translate-y-1 bg-[#6c08b0] hover:bg-blue-700 text-white relative z-10">
                    ...
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        ...
                        <div className="flex gap-2 mt-2">
                           <Badge className="bg-[#820AD1]/10 text-[#820AD1] font-black text-[8px] uppercase border-none">{profile.niche || 'Nicho Global'}</Badge>
                           <Badge className={`font-black text-[8px] uppercase border-none ${profile.isActive ? 'bg-[#820AD1]/10 text-[#820AD1]' : 'bg-slate-100 text-slate-400'}`}>
                  ...
                  <div className="space-y-6 flex-1">
                    <div className="bg-slate-50 p-6 rounded-[30px] space-y-4">
                       <div className="flex items-center gap-3">
                          <Brain className="w-4 h-4 text-[#820AD1]" />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                       <div className="p-5 bg-purple-50/50 rounded-3xl">
                          <p className="text-[8px] font-black text-[#820AD1] uppercase tracking-widest mb-1">Pesquisas/Dia</p>
                          <p className="text-xl font-black text-slate-900">{profile.dailyResearchLimit}</p>
                       </div>
                       <div className="p-5 bg-purple-50/50 rounded-3xl">
                          <p className="text-[8px] font-black text-[#820AD1] uppercase tracking-widest mb-1">Contatos/Dia</p>
        ...
        <DialogContent className="max-w-4xl p-0 border-none shadow-3xl bg-white overflow-hidden rounded-[40px]">
          <div className="flex flex-col md:flex-row h-[85vh]">
            <div className="w-full md:w-80 bg-slate-900 p-12 flex flex-col justify-between relative overflow-hidden">
               <div className="absolute top-0 left-0 w-48 h-48 bg-[#820AD1]/10 blur-[80px] rounded-full translate-x-[-50%] translate-y-[-50%]" />
               <div className="space-y-12 relative z-10">
                  <div className="w-20 h-20 bg-[#6c08b0] rounded-3xl flex items-center justify-center shadow-2xl">
                     <Target className="w-10 h-10 text-white" />
                  </div>
                  <div className="space-y-4">
                     <h3 className="text-3xl font-black text-white tracking-tighter uppercase leading-tight">Configurar <span className="text-[#820AD1] italic">Jornada</span></h3>
               ...
               <div className="p-6 bg-white/5 rounded-[30px] border border-white/5 space-y-3">
                  <p className="text-[9px] font-black text-[#820AD1] uppercase tracking-widest">Dica Premium</p>
               ...
               <div className="space-y-10">
                  <section className="space-y-6">
                     <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest flex items-center gap-3">
                        <Layout className="w-4 h-4 text-[#820AD1]" /> Identificação do Alvo
                     </h4>
                  ...
                  <section className="space-y-6">
                      <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest flex items-center gap-3">
                         <Target className="w-4 h-4 text-[#820AD1]" /> Perfil Detalhado (Contexto SDR)
                      </h4>
                      <div className="grid grid-cols-2 gap-6">
                         <div className="space-y-2">
                  ...
                  <section className="space-y-6">
                      <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest flex items-center gap-3">
                         <Briefcase className="w-4 h-4 text-[#820AD1]" /> Agente Responsável
                      </h4>
                      <div className="space-y-2">
                  ...
                  <section className="space-y-6">
                     <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest flex items-center gap-3">
                        <Brain className="w-4 h-4 text-[#820AD1]" /> Inteligência de Pesquisa
                     </h4>
                     <div className="space-y-4">
                        <div className="space-y-2">
                  ...
                  <section className="space-y-6">
                     <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest flex items-center gap-3">
                        <Sliders className="w-4 h-4 text-[#820AD1]" /> Limites e Automação
                     </h4>
                     <div className="grid grid-cols-2 gap-6">
                        <div className="space-y-2">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                        <div className="flex items-center justify-between p-6 bg-slate-50 rounded-3xl">
                           ...
                           <Switch checked={form.isAutoHunterEnabled} onCheckedChange={v => setForm({...form, isAutoHunterEnabled: v})} className="data-[state=checked]:bg-[#6c08b0]" />
                        </div>
                        <div className="flex items-center justify-between p-6 bg-slate-50 rounded-3xl">
                           <div className="space-y-0.5">
                           ...
                           <Switch checked={form.isProspectingActive} onCheckedChange={v => setForm({...form, isProspectingActive: v})} className="data-[state=checked]:bg-[#6c08b0]" />
                        </div>
                     </div>
                  </section>
                  ...
                  <div className="flex gap-4 pt-6 border-t border-slate-100">
                     <Button onClick={handleSave} className="flex-[3] h-20 bg-slate-900 hover:bg-black text-white font-black rounded-3xl uppercase tracking-widest shadow-2xl transition-all hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-3">
                        <Save className="w-5 h-5 text-[#820AD1]" /> Salvar Configurações da Jornada
                     </Button>
