...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 font-sans relative overflow-hidden">
      {/* Decorative blobs */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-[#2563EB]/10 blur-[100px] rounded-full translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#2563EB]/10 blur-[80px] rounded-full -translate-x-1/2 translate-y-1/2" />
      ...
      <div className="max-w-lg w-full text-center space-y-10 relative z-10">
        ...
        <div className="space-y-4">
          ...
          <h1 className="text-5xl lg:text-7xl font-bold text-slate-900 tracking-tight leading-[0.9]">
            Página <span className="text-[#2563EB] italic">não encontrada.</span>
          </h1>
