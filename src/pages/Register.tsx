      ...
      <div className="max-w-4xl w-full grid grid-cols-1 lg:grid-cols-2 bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden relative z-10">
        ...
        <div className="bg-slate-900 p-12 text-white flex flex-col justify-between relative overflow-hidden hidden lg:flex">
           ...
           <div className="flex items-center gap-3 relative z-10">
              ...
              <span className="text-2xl font-bold tracking-tight text-white">Auto<span className="text-[#0D9488] italic">Sales</span></span>
           </div>
        ...
        <div className="p-8 lg:p-12 flex flex-col justify-center">
            <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
               ...
               <Button onClick={handleRegister} disabled={loading} className="w-full h-14 bg-[#0D9488] hover:bg-[#0F766E] text-white rounded-2xl font-bold text-base gap-3 shadow-xl ">
